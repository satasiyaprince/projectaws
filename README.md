# Xr-Management serverless API
The Xr-Management project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=Xr-Management -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot-archetype -DarchetypeVersion=1.4 -DgroupId=com.Xr.Management -Dversion=0.0.1 -Dinteractive=false
$ cd Xr-Management
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "XrManagementApi",
                    "OutputKey": "XrManagementApi",
